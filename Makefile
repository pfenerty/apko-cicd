...
$(eval $(call IMAGE,tools-apko,tools/apko/apko.yaml,apko:1.2.20))
$(eval $(call IMAGE,tools-melange,tools/melange/apko.yaml,melange:0.55.0))
...
$(eval $(call IMAGE,tools-gcloud,tools/gcloud/apko.yaml,gcloud:575.0.0))
