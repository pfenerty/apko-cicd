...
# ── Tools ────────────────────────────────────────────────────────────────────
$(eval $(call IMAGE,tools-syft,tools/syft/apko.yaml,syft:1.51.0))
$(eval $(call IMAGE,tools-grype,tools/grype/apko.yaml,grype:0.117.0))
...
$(eval $(call IMAGE,tools-apko,tools/apko/apko.yaml,apko:1.2.39))
$(eval $(call IMAGE,tools-melange,tools/melange/apko.yaml,melange:0.56.3))
$(eval $(call IMAGE,tools-golangci-lint-go1.22,tools/golangci-lint/1.22.yaml,golangci-lint:2.13.1-go1.22))
$(eval $(call IMAGE,tools-golangci-lint-go1.23,tools/golangci-lint/1.23.yaml,golangci-lint:2.13.1-go1.23))
$(eval $(call IMAGE,tools-golangci-lint-go1.24,tools/golangci-lint/1.24.yaml,golangci-lint:2.13.1-go1.24))
$(eval $(call IMAGE,tools-golangci-lint-go1.25,tools/golangci-lint/1.25.yaml,golangci-lint:2.13.1-go1.25))
$(eval $(call IMAGE,tools-golangci-lint-go1.26,tools/golangci-lint/1.26.yaml,golangci-lint:2.13.1-go1.26))
$(eval $(call IMAGE,tools-govulncheck-go1.22,tools/govulncheck/1.22.yaml,govulncheck:1.7.0-go1.22))
$(eval $(call IMAGE,tools-govulncheck-go1.23,tools/govulncheck/1.23.yaml,govulncheck:1.7.0-go1.23))
$(eval $(call IMAGE,tools-govulncheck-go1.24,tools/govulncheck/1.24.yaml,govulncheck:1.7.0-go1.24))
$(eval $(call IMAGE,tools-govulncheck-go1.25,tools/govulncheck/1.25.yaml,govulncheck:1.7.0-go1.25))
$(eval $(call IMAGE,tools-govulncheck-go1.26,tools/govulncheck/1.26.yaml,govulncheck:1.7.0-go1.26))
...
$(eval $(call IMAGE,tools-gcloud,tools/gcloud/apko.yaml,gcloud:581.0.0))
