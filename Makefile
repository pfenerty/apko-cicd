...
# ── Tools ────────────────────────────────────────────────────────────────────
$(eval $(call IMAGE,tools-syft,tools/syft/apko.yaml,syft:1.45.1))
$(eval $(call IMAGE,tools-grype,tools/grype/apko.yaml,grype:0.114.0))
$(eval $(call IMAGE,tools-oras,tools/oras/apko.yaml,oras:1.3.2))
$(eval $(call IMAGE,tools-apko,tools/apko/apko.yaml,apko:1.2.15))
$(eval $(call IMAGE,tools-melange,tools/melange/apko.yaml,melange:0.52.0))
...
$(eval $(call IMAGE,tools-gcloud,tools/gcloud/apko.yaml,gcloud:571.0.0))
