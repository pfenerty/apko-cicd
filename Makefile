...
$(eval $(call IMAGE,tools-apko,tools/apko/apko.yaml,apko:1.2.17))
$(eval $(call IMAGE,tools-melange,tools/melange/apko.yaml,melange:0.54.0))
...
$(eval $(call IMAGE,tools-gcloud,tools/gcloud/apko.yaml,gcloud:573.0.0))
